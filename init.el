...
(defun dotspacemacs/init ()
  (let ((is_mac (eq (window-system) 'ns)))
  "Initialization:
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font `("Source Code Pro" ;;Consolas
                               :size ,(if (> (display-pixel-width) 1440) 22 12)
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
   ;; The leader key
   ...
   ;; (Emacs 24.4+ only)
   dotspacemacs-fullscreen-at-startup is_mac
   ...
   dotspacemacs-maximized-at-startup (not is_mac)
